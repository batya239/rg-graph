...
for label in labels:
    ...
    f = feynman.Feynman(n, theory=3)
    print '### ' + label + ':\n' + str(f)

    sectors = feynman.sectors(n, conservation_laws=f._conslaws, symmetries=True)
    print str(len(sectors)) + " symmetrically non-equivalent sectors"
