...
int main()
{
    ...
    if (NDIM > 1)
    {
        Divonne(NDIM, NCOMP, Integrand, USERDATA, NVEC, EPSREL, EPSABS, verbose,
                SEED, MINEVAL, MAXEVAL, KEY1, KEY2, KEY3, MAXPASS, BORDER,
                MAXCHISQ, MINDEVIATION, NGIVEN, LDXGIVEN, NULL, NEXTRA, NULL,
