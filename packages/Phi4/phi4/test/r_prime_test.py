...
class RPrimeTestCase(unittest.TestCase):
    ...
    def test_one_loop_diagram(self):
        ...
        self.assertEquals(symbolic_functions.evaluate("1/e"), self.operator.kr1(g).simplify_indexed().convert_to_poly(True))

    def test_eye(self):
        g = graph_util.init_weight(graphine.Graph(graph_state.GraphState.fromStr("e112|2|e|")))
        self.assertEquals(symbolic_functions.evaluate("1/(2*e) - 1/(2*e**2)"), self.operator.kr1(g).simplify_indexed().convert_to_poly(True))

    def test_some_diagram(self):
        g = graph_util.init_weight(graphine.Graph(graph_state.GraphState.fromStr("e13|23|33|e|")))
        self.assertEquals(symbolic_functions.evaluate("2/(3*e) - 1/(2*e**2) + 1/(6*e**3)"), self.operator.kr1(g).simplify_indexed().convert_to_poly(True))

    def test_e111_e_(self):
        g = graph_util.init_weight(graphine.Graph(graph_state.GraphState.fromStr("e111|e|")))
        self.assertEquals(symbolic_functions.evaluate("-p**2/(4*e)"), self.operator.kr1(g).simplify_indexed().convert_to_poly(True))

    def test_e11_22_e_(self):
        g = graph_util.init_weight(graphine.Graph(graph_state.GraphState.fromStr("e11|22|e|")))
        self.assertEquals(symbolic_functions.evaluate("-1/e**2"), self.operator.kr1(g).simplify_indexed().convert_to_poly(True))

    def test_e112_22_e_(self):
        g = graph_util.init_weight(graphine.Graph(graph_state.GraphState.fromStr("e112|22|e|")))
        self.assertEquals(symbolic_functions.evaluate("-1*p**2/(12*e) + p**2/(6*e**2)"), self.operator.kr1(g).simplify_indexed().convert_to_poly(True))
    ...
    def test_e11_22_33_e_(self):
        ...
        self.assertEquals(symbolic_functions.evaluate("1/e**3"), self.operator.kr1(g).simplify_indexed().convert_to_poly(True))

    def test_e11_23_e33__(self):
        self._do_test_r1("e11|23|e33||::", "-1/(2*e**2) + 1/(2*e**3)")

    def test_e13_e22_33__(self):
        self._do_test_r1("e13|e22|33||::", "-1/(3*e) - 1/(3*e**2) + 1/(3*e**3)")

    def test_e112_e3_33__(self):
        self._do_test_r1("e112|3|e33||::", "-1/(3*e) - 1/(3*e**2) + 1/(3*e**3)")

    def test_e13_e23_33__(self):
        self._do_test_r1("e13|e23|33||::", "2/(3*e) - 1/(2*e**2) + 1/(6*e**3)")

    ####4 LOOPS

    def test_e113_22_33_e_(self):
        self._do_test_r1("e113|22|33|e|::", "5*p**2/(32*e) + 1*p**2/(16*e**2) - 1*p**2/(8*e**3)")

    def test_e12_e3_333__(self):
        self._do_test_r1("e12|e3|333||::", "-3/(8*e) + 1/(6*e**2)")

    def test_e11_22_33_44_e_(self):
        self._do_test_r1("e11|22|33|44|e|::", "-1/(e**4)")

    def test_e11_22_34_e44_(self):
        self._do_test_r1("e11|22|34|e44|::", "1/(2*e**3) - 1/(2*e**4)")

    def test_e112_2_34_44_e_(self):
        self._do_test_r1("e112|2|34|44|e|::", "-1/(4*e**2) + 1/(2*e**3) - 1/(4*e**4)")

    def test_e112_e3_e44_e44__(self):
        self._do_test_r1("e112|e3|e44|e44||::", "((0.5-zeta(3))/2/e+1./2/2/e**2+2./2/2/2/e**3-4./2/2/2/2/e**4)")
    ...
    def test_e112_e3_333__(self):
        self._do_test_r1("e112|e3|333||", "5*p**2/(32*e)-p**2/(32*e**2)")
    ...
    def _do_test_r1(self, graph_state_str, expected_result_as_string):
        ...
        actual = self.operator.kr1(g).simplify_indexed().convert_to_poly(True)
...
class RPrimeWithCalculatorTestCase(unittest.TestCase):
    ...
    def test_e12_223_3_e_(self):
        r.ROperation.set_debug(True)
        self._do_test_r1("e12|223|3|e|", "1/(3*e) - 2/(3*e**2) + 1/(3*e**3)")

    def test_e123_e23_33__(self):
        self._do_test_r1("e123|e23|33||", "-13*p**2/(96*e) + 7*p**2/(48*e**2) - 1*p**2/(24*e**3)")

    def test_e12_e23_33__(self):
        self._do_test_r1("e12|e23|33||", "1/(6*e**3) - 0.5/e**2 + 2/(3*e)")

    def test_e1123_2_e33__(self):
        self._do_test_r1("e1123|2|e33||", "p**2*(-1/(24*e**3) + 5/(48*e**2) + 1/(96*e))")

    def test_ee12_e23_334_4_e_(self):
        self._do_test_r1('ee12|e34|334|4|e|', "(5/2-2*zeta(3))/2/e-19/6/2/2/e**2+2/2/2/2/e**3-2/3/2/2/2/2/e**4")

    def test5loops(self):
        self._do_test_r1("ee12|e34|345|45|5|e|", "(-(23./5*zeta(5)-21./10*zeta(4)-5.*zeta(3))/2/e-(12./5*zeta(4)+36./5*zeta(3))/4/e/e+24./5*zeta(3)/8/e/e/e)")
