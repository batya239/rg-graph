...
def _compareRPrime(graph, expected, useGraphCalculator=False):
    ...
    except phi4.common.CannotBeCalculatedError as e:
        print "FAIL", str(graph), e
...
def main():
    try:
        ...
        storage.closeStorage(revert=False, doCommit=True, commitMessage="5loops checking, phi4_kr1_answers.py")
