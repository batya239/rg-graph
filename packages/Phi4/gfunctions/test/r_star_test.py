...
import graphine
import rggraphutil.env.graph_calculator
    ...
    def doTestKRStar(self, graphStateAsString, expectedResultAsString, useGraphCalculator=False):
        try:
            if useGraphCalculator:
                rggraphutil.env.graph_calculator.addCalculator(mincer_adapter.MincerGraphCalculator())
            ...
            rggraphutil.env.graph_calculator.dispose()
