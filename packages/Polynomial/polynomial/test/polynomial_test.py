...
c2_2 = 5
p2 = Polynomial({mi1_1: c2_1, mi2_2: c2_2}, (1, 2), (3, 1))
...
class PolynomialTestCase(PolynomialToolsTestCase):
    ...
    def testChangeVarToPolynomial(self):
        ...
        self.assertEquals(_p1.monomials[MultiIndex({1: 3, 2: 7, 4: 4, 3: 1})], 81)
        self.assertEquals(_p1.monomials[MultiIndex({1: 1, 2: 7, 4: 4, 3: 3})], 243)
