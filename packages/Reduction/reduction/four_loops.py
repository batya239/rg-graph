...
#1row
#M61
masters["e12|34|35|6|67|67|e||"] = "_g11()**(-4)*exp(-4*Euler*e)*(-10*zeta(5)/e+50*zeta(5)-10*zeta(3)**2-25*zeta(6)+e*(90*zeta(5)+50*zeta(3)**2+125*zeta(6)-30*zeta(3)*zeta(4)+19*zeta(7)/2)))+O(e**2)"
#M62
masters["e12|34|56|56|57||7|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(-10*zeta(5)/e+130*zeta(5)-10*zeta(3)**2-25*zeta(6)-70*zeta(7))+O(e)"
#M63
masters["e12|34|35|6|56|7|7|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(-5*zeta(5)/e+45*zeta(5)-41*zeta(3)**2-25*zeta(6)/2+161*zeta(7)/2)+O(e)"
#M51
masters["e12|34|345|6|6|e6||"] = "_g11()**(-4)*exp(-4*Euler*e)*(-5*zeta(5)/e+45*zeta(5)-17*zeta(3)**2-25*zeta(6)/2+e(-195*zeta(5)+153*zeta(3)**2+225*zeta(6)/2-51*zeta(3)*zeta(4)-85*zeta(7)/2))+O(e**2)"

#row2
#M41
masters["e12|334|34|5|5|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(20*zeta(5)/e-80*zeta(5)-22*zeta(3)**2+50*zeta(6)+e*(80*zeta(5)+88*zeta(3)**2-200*zeta(6)-66*zeta(3)*zeta(4)+4685*zeta(7)/8))+O(e**2)"
#M42
masters["e112|34|34|5|5|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(20*zeta(5)/e-80*zeta(5)+8*zeta(3)**2+50*zeta(6)+e*(80*zeta(5)-32*zeta(3)**2-200*zeta(6)+24*zeta(3)*zeta(4)+520*zeta(7)))+O(e**2)"
#M44
masters["e12|23|34|45|5|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(441*zeta(7)/8)+O(e)"
#M45
masters["e12|234|34|5|5|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(36*zeta(3)**2+e*(108*zeta(3)*zeta(4)-378*zeta(7)))+O(e**2)"

#row3
#M34
masters["e12|233|34|4|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(1/e**4/12+1/e**3/4+7/e**2/12-17/e/12+25*zeta(3)/6/e-377/12+25*zeta(3)/2+25*zeta(4)/4" \
...
#M35
masters["e12|234|34|e4||"] = "_g11()**(-4)*exp(-4*Euler*e)*(zeta(3)/2/e/e+(3*zeta(3)/2+3*zeta(4)/4)/e+19*zeta(3)/4+9*zeta(4)/4-23*zeta(5)/2" \
                             "+e*(103*zeta(3)/3+57*zeta(4)/4-69*zeta(5)/2+29*zeta(3)**2/2-30*zeta(6))" \
                             "+e**2*(547*zeta(3)/2+309*zeta(4)/4-437*zeta(5)/2+87*zeta(3)**2/2-90*zeta(6)+87*zeta(3)*zeta(4)/2-1105*zeta(7)/4))+O(e**3)"
#M36
masters["e123|234|4|4|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(5*zeta(5)/e-5*zeta(5)-7*zeta(3)**2+25*zeta(6)/2+e*(35*zeta(5)+7*zeta(3)**2-25*zeta(6)/2-21*zeta(3)*zeta(4)+127*zeta(7)/2))+O(e**2)"
#M52
masters["e11|23|45|45|6|6|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(20*zeta(5)/e-80*zeta(5)+68*zeta(3)**2+50*zeta(6)+e*(80*zeta(5)-272*zeta(3)**2-200*zeta(6)+204*zeta(3)*zeta(4)+450*zeta(7)))+O(e**2)"

#row4
#M43
masters["e123|e45|45|45|||"] = "_g11()**(-4)*exp(-4*Euler*e)*(-5*zeta(5)/e+45*zeta(5)-17*zeta(3)**2-25*zeta(6)/2+e*(-195*zeta(5)+153*zeta(3)**2+225*zeta*(6)/2-51*zeta(3)*zeta(4)-225*zeta(7)/2))+O(e**2)"
#M32
masters["e11|23|334|4|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(1/3/e**4+1/3/e**3+1/3/e**2+(-7/3+14*zeta(3)/3)/e-67/3+14*zeta(3)/3+7*zeta(4)" \
...
#M33
masters["e12|334|334||e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(1/6/e**4+1/3/e**3+1/3/e**2+(-17/3+31*zeta(3)/3)/e-197/3+62*zeta(3)/3+31*zeta(4)/2" \
...
#M21
masters["e112|223|3|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(-5/48/e**3-31/96/e**2-95/192/e+1133/384-19*zeta(3)/12" \
...
#row5
#M22
masters["e112|23|33|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(-1/4/e**3-3/2/e**2-33/4/e-175/4+10*zeta(3)+e*(-1825/8+113*zeta(3)/2+15*zeta(4))" \
...
#M26
masters["e123|e23|33||"] = "_g11()**(-4)*exp(-4*Euler*e)*(-1/8/e**3-13/16/e**2-141/32/e-1393/64+2*zeta(3)+e*(-12997/128+13*zeta(3)+3*zeta(4))" \
...
#M27
masters["e12|2223|3|e|"] = "_g11()**(-4)*exp(-4*Euler*e)*(1/48/e**3+7/96/e**2+11/192/e-605/384+7*zeta(3)/6" \
