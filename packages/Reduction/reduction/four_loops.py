...
masters["e12|334|334||e|"] = "(1/6/e**4+1/3/e**3+1/3/e**2+(-17/3+31*zeta(3)/3)/e-197/3+62*zeta(3)/3+31*zeta(4)/2" \
                             ...
                             "-1966*zeta(3)**2/3+6580*zeta(6)/3-983*zeta(3)*zeta(4)+11338*zeta(7)))+O(e**4)"
#M21
...
FOUR_LOOP_REDUCTOR = reductor.Reductor("p4",
                                       ...
                                       4,
                                       dict(map(lambda (g, v): (graphine.Graph.fromStr(g), symbolic_functions.evaluate(v, strong_to_internal_code=True)), masters.iteritems())))