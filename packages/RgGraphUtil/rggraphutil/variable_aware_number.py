...
class VariableAwareNumber(object):
    ...
    def __div__(self, other):
        if isinstance(other, VariableAwareNumber) and other.isRealNumber():
            other = other.a
        if isinstance(other, int) or isinstance(other, float):
            return VariableAwareNumber(self.varName, self.a / other, self.b / other)

    def __mul__(self, other):
        otherEpsPower = other if isinstance(other, VariableAwareNumber) else VariableAwareNumber.create(self.varName, other)
