...
#tmp = 1/(
#         (q1*q1+1)**3*(q2**2+1)**3*(q3*q3+1)*(q1**2+q2**2/2+1+q1xq2)*(q3**2+q2**2/2+1-q2xq3)**2
#         ) * (
#              (1/(q3**2+1)+1/((q3**2+q2**2/2+1-q2xq3)**2))*
#              ( 
#               ((-q2**2/2-q1xq2)*(3+3*q1**2+q2**2+2*q1xq2))/(2*(q1**2+q2**2/2+1+q1xq2)) +
#               (3*(q2**4/4+q1**2*q2**2/4+q2**2*q1xq2+q1**2*q2**2*q1xq2-q2**2*q1xq2**2/2-
#                 q1xq2**3) )/(2*(q1**2+1)*(q2**2+1)) 
#               ) + 1/(q1**2+1)*(
#                                q2**2/4+q1**2*q2**4/4+q2**2*q1xq2+q1**2*q2**2*q1xq2-q2**2*q1xq2**2/2 -q1xq2**3
#                                )*(
#                                   1/((q3**2+1)**2)+3/(2*(q2**2/2+q3**2+1-q1xq2)**2) 
#                                   + 3/(2*(q3**2+1)*(q2**2/2+q3**2+1-q2xq3)) 
#                                   ) 
#              )
...
tmp = (
       (-q1*q1/2-q1xq2)*(3+3*q2**2+q1**2+2*q1xq2)
       )/(
          2*(q1**2+1)**3*(q2**2+1)**3*(q3**2+1)*
          (q2**2+q1**2/2+1+q1xq2)**2*(q3**2+q1**2/2+1-q1xq3)**2
          )*(
             1/(q3**2+1)+1/(q3**2+q1**2/2+1-q1xq3)
             )
tmp = 1/((q1**2+q2**2+1)**3*(q2**2+1)**4*(q3**2+1)**4)
            
k2term = rggrf.roperation.Factorized(1,tmp)

s_prep =   ExpandScalarProdsAndPrepareFactorized(k2term)

#print "---------dm_%s_p%s --------- " %(idxL,idxK2)
sys.stdout.flush()
prepared_eqs.append(rggrf.integration.PrepareFactorizedStrVars(s_prep, SPACE_DIM, ignore_unknown=True, simplify = False))
