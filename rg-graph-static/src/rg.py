...
G3 = (-g*(0.750000353982726 - 0.536233762649774*eps - 1.00000028867187/eps) - 
      g**2*(3.06128503353258 - 0.959657003971711*eps - 2.35416311194034/eps + 
            1.25000021001422/eps**2) - 
      g**3*(7.81740005363973 - 10.5510491241102/eps - 1.66666630630782/eps**3 + 
            5.28690425966290/eps**2))
...
#G3 = (-g*(0.750000353982726 - 0.536233762649774*eps - 1.00000028867187/eps) - 
#      g**2*(3.06128503353258  - 2.35416311194034/eps + 
#            1.25000021001422/eps**2) - 
#      g**3*(- 10.5510491241102-0.071492051999999973/eps - 1.66666630630782/eps**3 + 
#            5.28690425966290/eps**2))
G2 =  (g*(0.125000347489694 - 0.0893725486373030*eps - 0.166666737855442/eps) + 
       g**2*(0.286044194049547  - 0.238485108572760/eps + 
             0.138888984956952/eps**2) + 
       g**3*((- 0.896541635268446)/eps - 0.146605021931999/eps**3 + 
             0.461482011432618/eps**2))
#G2 =  (g*(0.125000347489694 - 0.0893725486373030*eps - 0.166666737855442/eps) + 
#       g**2*(0.286044194049547  - 0.238485108572760/eps + 
#             0.138888984956952/eps**2) + 
#       g**3*(- 0.88485218557425815/eps - 0.146605021931999/eps**3 + 
#             0.461482011432618/eps**2))
#vi
##G2 =  (g*(0.125000347489694 - 0.0893725486373030*eps - 0.166666737855442/eps) + 
#       g**2*(0.286044194049547 - 0.104085578494757*eps - 0.238485108572760/eps + 
#             0.138888984956952/eps**2) + 
#       g**3*(0.669917578268912 -0.5549775 /eps - 0.146605021931999/eps**3 + 
#             0.461482011432618/eps**2))
#G2 =  (g*(0.125000347489694 - 0.0893725486373030*eps - 0.166666737855442/eps) + 
#       g**2*(0.286044194049547  - 0.238485108572760/eps + 
#             0.138888984956952/eps**2) + 
#       g**3*( -0.884852 /eps - 0.146605021931999/eps**3 + 
#             0.4563707/eps**2))
