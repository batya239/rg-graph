...
def reduce_to_r(expr):
    ...
    r_map={
       ...
       2*n**3 + 76*n**2 + 643*n + 1466          : r[22]*729, 
       3*n**3 + 38*n**2 + 224*n + 464           : r[23]*729, 
       3*n**3 + 42*n**2 + 244*n + 440           : r[24]*729, 
       3*n**3 + 50*n**2 + 252*n + 424           : r[25]*729, 
       5*n**3 + 56*n**2 + 252*n + 416           : r[26]*729, 
       5*n**3 + 64*n**2 + 260*n + 400           : r[27]*729, 
       9*n**3 + 76*n**2 + 260*n + 384           : r[28]*729,       
       n**4 + 16*n**3 + 88*n**2 + 256*n + 368   : r[29]*729,
       n**4 + 16*n**3 + 96*n**2 + 264*n + 352   : r[30]*729,       
       n**4 + 12*n**3 + 68*n**2 + 248*n + 400   : r[31]*729,
       n**4 + 12*n**3 + 76*n**2 + 256*n + 384   : r[32]*729,
       3*n**4 + 30*n**3 + 120*n**2 + 256*n + 320: r[33]*729,        

       53*n**2 + 598*n + 1536                               : r[34]*2187,
       n**3 + 65*n**2 + 619*n + 1502                        : r[35]*2187,       
