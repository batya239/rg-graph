...
class SubGraphReducerTestCase(unittest.TestCase):
    ...
    def testReducing(self):
        edges = list()
        edges.append(graph_state.Edge((-1, 0), colors=(1, 0)))
        edges.append(graph_state.Edge((-1, 0), colors=(1, 0)))
        ...
        edges.append(graph_state.Edge((1, 2), colors=(1, 0)))
        edges.append(graph_state.Edge((-1, 1), colors=(1, 0)))
        edges.append(graph_state.Edge((-1, 2), colors=(1, 0)))
        ...
        b = reducer.nextIteration()
        reducer.nextIteration()
