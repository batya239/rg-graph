...
// getCmdLineArgumentString(argc, (const char**)argv, "ncall", &nCallStr);
// getCmdLineArgumentInt(argc, (const char**)argv, "itmx", &itmx0);
// getCmdLineArgumentFloat(argc, (const char**)argv, "acc", &acc0);
// getCmdLineArgumentInt(argc, (const char**)argv, "blk", &nBlockSize0);
// getCmdLineArgumentInt(argc, (const char**)argv, "dev", &GPUdevice);

   getCmdLineArgumentString(argc, (const char**)argv, "ncall", &nCallStr);
   itmx0 = getCmdLineArgumentInt(argc, (const char**)argv, "itmx");
   acc0 = getCmdLineArgumentFloat(argc, (const char**)argv, "acc");
   nBlockSize0 = getCmdLineArgumentInt(argc, (const char**)argv, "blk");
   GPUdevice = getCmdLineArgumentInt(argc, (const char**)argv, "dev");
